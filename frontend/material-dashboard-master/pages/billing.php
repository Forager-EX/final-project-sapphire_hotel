...
<html lang="en">
  <head>
    ...
    <title>Material Dashboard 3 by Sapphire Hotel</title>
    <!--     Fonts and icons     -->
    <link
      rel="stylesheet"
      type="text/css"
                ...
                <div class="card bg-transparent shadow-xl">
                  ...
                  >
                    ...
                    <div class="card-body position-relative z-index-1 p-3">
                      <i class="material-symbols-rounded text-white p-2"
                        >wifi</i
                      >
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-md-0 mb-4">
                        ...
                        >
                          ...
                          <i
                            class="material-symbols-rounded ms-auto text-dark cursor-pointer"
                ...
                <ul class="list-group">
                  ...
                  >
                    ...
                    <div class="d-flex align-items-center text-sm">
                      ...
                      >
                        <i
                          class="material-symbols-rounded text-lg position-relative me-1"
                          >picture_as_pdf</i
                        >
                        PDF
                      </button>
            ...
            <div class="card h-100 mb-4">
              <div class="card-header pb-0 px-3">
                <div class="row">
                  ...
                  >
                    <i class="material-symbols-rounded me-2 text-lg"
                      >date_range</i
                    >
                ...
                <ul class="list-group">
                  ...
                  >
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm">Adriane</h6>
                  ...
                  >
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm">Maria</h6>
                ...
                <ul class="list-group">
                  ...
                  >
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm">John Paul</h6>
                  ...
                  >
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm">Delia</h6>
